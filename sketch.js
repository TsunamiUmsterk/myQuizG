...
var cube2;
var correctSo, wrongSo;

function preload() {
     appleImg = loadImage("apple2.png");
     bananaImg = loadImage("banana2.png");

     correctSo = loadSound("Correct Sound.mp4");
     wrongSo = loadSound("Wrong Sound.mp4");
}
...
function badAns() {
     ...
     next.style("font-size: 20px; font-family: Marker Felt; border-radius: 40px;");
...
function wellAns() {
     ...
     next.size(displayWidth/6, displayHeight/15);
     next.style("font-size: 25px; font-family: Marker Felt; border-radius: 40px;");
     next.mousePressed(refresh);
